...
//   const generateTitle = (fullPath: string) => {
//     console.log('Full Path:', fullPath)
//     const routeSegments = fullPath.split('/')
...
//     console.log('Non-Empty Segments:', nonEmptySegments)
...
//       const firstSegmentTitle = firstSegment
//         .split('-')
//         .map((word: string) => word.charAt(0).toUpperCase() + word.slice(1))
//         .join(' ')

//       // Check if the last segment is "add" or "edit" and exclude it
//       if (lastSegment === 'add' || lastSegment === 'edit') {
//         return firstSegmentTitle
//       }

//       // Check if the first and last segments are the same
//       if (firstSegment === lastSegment) {
//         return firstSegmentTitle
//       } else {
//         return `${firstSegmentTitle} - ${lastSegment}`
//       }
//     } else {
...
//   useEffect(() => {
//     const extractedTitle = generateTitle(fullPath)
